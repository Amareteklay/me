      ...
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item xs={12} md={8}>
          ...
          <Typography variant="body1" sx={{ mb: 2 }}>
            ...
            skills in [Your Technical Skills] and am driven to create meaningful
            projects.
          </Typography>
          <Typography variant="body1">
            Beyond work, I enjoy exploring [Your Hobbies/Interests] and
            reflecting on the lessons life has to offer. My journey is fueled by
            curiosity, resilience, and a commitment to growth.
          </Typography>
        </Grid>
      </Grid>
